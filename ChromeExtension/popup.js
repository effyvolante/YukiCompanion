...
document.getElementById("bind").onclick = async () => {
  ...
  if (!tab?.url?.startsWith("https://chatgpt.com/") && !tab?.url?.startsWith("https://chat.openai.com/")) { status.textContent = "Open the Yuki Work chat on chatgpt.com first."; return; }

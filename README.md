...
The stable release line begins with **Yuki Companion v1.0.0**. Backward-compatible fixes increment the patch number (`v1.0.1`); compatible feature releases increment the minor number (`v1.1.0`). Breaking product changes move to the next major version (`v2.0.0`).

...
with (contents / 'Info.plist').open('wb') as f:
    plistlib.dump(dict(CFBundleIdentifier='com.effy.wowcompanion', CFBundleName='Yuki Companion', CFBundleDisplayName='Yuki — App Companion', CFBundleExecutable='EffyWoWCompanion', CFBundleIconFile='YukiIcon.icns', CFBundlePackageType='APPL', CFBundleVersion='9', CFBundleShortVersionString='0.2.7', LSMinimumSystemVersion='13.0', NSHighResolutionCapable=True), f)

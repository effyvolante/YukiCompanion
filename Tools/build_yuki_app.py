...
app = root / 'outputs' / 'Effy WoW Companion.app'
...
with (contents / 'Info.plist').open('wb') as f:
    plistlib.dump(dict(CFBundleIdentifier='com.effy.wowcompanion', CFBundleName='Effy WoW Companion', CFBundleDisplayName='Yuki — Effy WoW Companion', CFBundleExecutable='EffyWoWCompanion', CFBundlePackageType='APPL', CFBundleVersion='1', CFBundleShortVersionString='0.1.0', LSMinimumSystemVersion='13.0', LSUIElement=True, NSHighResolutionCapable=True), f)
...
# behavior.
desktop_app = pathlib.Path.home() / 'Desktop' / 'Effy WoW Companion.app'

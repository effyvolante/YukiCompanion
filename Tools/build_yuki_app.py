...
with (contents / 'Info.plist').open('wb') as f:
    plistlib.dump(dict(CFBundleIdentifier='com.effy.wowcompanion', CFBundleName='Effy WoW Companion', CFBundleDisplayName='Yuki — Effy WoW Companion', CFBundleExecutable='EffyWoWCompanion', CFBundlePackageType='APPL', CFBundleVersion='1', CFBundleShortVersionString='0.1.0', LSMinimumSystemVersion='13.0', NSHighResolutionCapable=True), f)
